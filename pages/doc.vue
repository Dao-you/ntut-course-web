...
- 在任一網址後方加入 `?mode=iframe` 即可使用嵌入功能。
 - 如：<code><iframe :src="$domain('/course/111/1/305013?mode=iframe')"></iframe></code>，效果如下。
<iframe :src="$domain('/course/111/1/305013?mode=iframe')" width="386px" height="512px" frameborder="0" style="border-radius: 8px;margin: 0 auto;display: block;border: 1px solid rgba(0, 0, 0, 0.1);"></iframe>
